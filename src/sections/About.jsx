...
export default function About() {
  ...
  return (
    <section id="about" ref={ref} className="py-20 sm:py-24 md:py-32 px-4 sm:px-6 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-12 lg:gap-20 items-center">
          <div>
            ...
            <div className={`grid grid-cols-3 gap-3 sm:gap-6 mt-10 ${visible ? "anim-fade-in-up" : "opacity-0"}`} style={{ animationDelay: "0.3s" }}>
              {aboutStats.map((s) => (
          ...
          <div className={`grid grid-cols-1 sm:grid-cols-2 gap-4 ${visible ? "anim-slide-right" : "opacity-0"}`} style={{ animationDelay: "0.2s" }}>
